...
- The Policy π **is the brain of our Agent**. It’s the function that tells us what action to take given the current state. So it defines the agent’s behavior at a given time.
