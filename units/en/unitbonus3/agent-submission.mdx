...
After finishing model training as explained in the [Reinforcement Learning Training]("https://huggingface.co/learn/deep-rl-course/unitbonus3/training"), you can create your agent script for submission as the one reported in the next code block, which will make use of the same configuration file used for training it.
