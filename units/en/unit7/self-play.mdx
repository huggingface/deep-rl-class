...
To get more details about these hyperparameters, you definitely need [to check out this part of the documentation](https://docs.unity3d.com/Packages/com.unity.ml-agents@4.1/manual/Training-Configuration-File.html#self-play)
