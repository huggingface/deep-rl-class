...
在上一单元，我们学习了我们的第一个强化学习算法：Q-learning，**从头开始实施**，并将其在两个环境（FrozenLake-v1 ☃️ and Taxi-v3 🚕.）中训练。
...
但是据目前所知，在大型状态空间环境下，**产生和更新 Q-table 会失效**。

所以在本单元，我们将要学习我们**第一个深度强化学习智能体**：深度 Q-learning。相比于用 Q-table ，深度 Q-learning 使用一个可以采用状态并给予该状态的估计每个动作 Q-value 的神经网络。
