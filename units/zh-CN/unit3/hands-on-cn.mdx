...
现在你已经学习了深度 Q 学习背后的理论，**你已经准备好训练你的深度 Q 学习智能体去玩 Atari 游戏了**。我们将从空间入侵开始，但是你可以用在任何你想要的 Atari 游戏里 🔥。
...
我们使用 [RL-Baselines-3 Zoo 集成, 深度 Q 学习的原始版本](https://stable-baselines3.readthedocs.io/en/master/modules/dqn.html) 其不包含像双深度 Q 网络 ，竞争深度 Q 网络或者优先经验回放的扩充。
...
# 让我们训练一个深度 Q 学习智能体去玩 Atari 空间入侵 👾 并把他上传到 Hub。
