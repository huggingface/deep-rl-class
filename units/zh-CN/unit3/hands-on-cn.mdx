...
现在你已经学习了深度 Q 学习背后的理论，**你已经准备好训练你的深度 Q 学习智能体去玩 Atari 游戏了**。我们将从 Space Invaders 开始，但是你可以用在任何你想要的 Atari 系列游戏里 🔥。


<img src="https://huggingface.co/datasets/huggingface-deep-rl-course/course-images/resolve/main/en/unit4/atari-envs.gif" alt="Environments"/>

我们使用的[RL-Baselines-3 Zoo 集成](https://github.com/DLR-RM/rl-baselines3-zoo), 一个深度 Q 学习的基础版本，没有像双深度 Q 网络 ，竞争深度 Q 网络或者优先经验回放的扩展。
...
在笔记中，你将使用 [RL Baselines3 Zoo](https://github.com/DLR-RM/rl-baselines3-zoo) ,一个基于 [Stable-Baselines3](https://stable-baselines3.readthedocs.io/en/master/) 的训练框架其可以使用脚本去训练，评估调整超参数图示结果和视频记录，训练一个深度 Q 学习智能体去玩 Space Invaders 游戏。
