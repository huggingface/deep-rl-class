# 哈吉的工作原理 [[how-huggy-works]]

哈吉是由 Hugging Face 制作的深度强化学习环境，基于 [Unity MLAgents 团队的项目 Puppo the Corgi](https://blog.unity.com/technology/puppo-the-corgi-cuteness-overload-with-the-unity-ml-agents-toolkit）。
...
在这种环境下，我们的目标是训练 哈吉**捡起我们扔的棍子。这意味着他需要正确地朝着棍子移动**。
...
鉴于所有这些信息，哈吉可以**使用他的策略来确定接下来要采取的行动来实现他的目标**。

## 动作空间，哈吉可以执行的动作 [[action-space]]
<img src="https://huggingface.co/datasets/huggingface-deep-rl-course/course-images/resolve/main/en/notebooks/unit-bonus1/huggy-action.jpg" alt="Huggy action" width="100%">

**关节电机驱动哈吉腿**。这意味着为了达到目标，哈吉需要**学会正确地旋转每条腿的关节马达，这样他才能移动**。
...
- *旋转惩罚*：如果 哈吉 旋转太多并且转得太快**，我们会对 哈吉 进行惩罚。
- *达到目标奖励*：我们奖励哈吉**达到目标**。
...
哈吉的目标是**学习正确并尽可能快地朝着目标奔跑**。为此，在每一步并根据环境观察，他需要决定如何旋转他腿的每个关节马达以正确移动（不要旋转太多）并朝向目标。
...
这是一个**棍子随机产生**的地方。当哈吉到达它时，棍子会在其他地方生成。
我们为训练构建了**环境的多个副本**。这有助于通过提供更多样化的体验来加快培训速度。



既然您已经了解了环境的大局，就可以训练哈吉去拿棍子了。

为此，我们将使用 [MLAgents](https://github.com/Unity-Technologies/ml-agents)。如果您以前从未使用过它，请不要担心。在本单元中，我们将使用 Google Colab 来训练哈吉，然后您就可以加载训练好的 哈吉并直接在浏览器中与他一起玩。
